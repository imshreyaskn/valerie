      ...
      <div className="flex-1 flex min-h-0 relative overflow-hidden">
        {isMissionControl ? (
          <main className="flex-1 overflow-y-auto" id="main-content">
            <div className="min-h-full max-w-7xl mx-auto px-6 md:px-16 pt-8 pb-32 flex flex-col">
              <Outlet />
            </div>
          </main>
        ) : (
          <main className="flex-1 overflow-y-auto" id="main-content">
            <div className="min-h-full max-w-7xl mx-auto px-6 md:px-16 pt-10 md:pt-12 pb-40">
              <Outlet />
            </div>
          </main>
        )}
