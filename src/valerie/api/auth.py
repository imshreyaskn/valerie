...
async def require_api_key(
    ...
    """
    # Safely unwrap parameters if invoked directly or via FastAPI Dependency Injection
    clean_x_api_key = x_api_key if isinstance(x_api_key, str) else None
    ...
    if clean_x_api_key:
        # Constant-time comparison to prevent side-channel timing attacks (B-01)
